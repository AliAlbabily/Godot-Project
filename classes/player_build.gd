...
@export var build_name: String = "Starting Build"

# Stat Modifiers/Base Values for this specific build
@export_group("Base Stats")
@export var build_hp: int = 0
@export var build_damage: int = 0
@export var build_defense: int = 0
@export var build_heal: int = 0
